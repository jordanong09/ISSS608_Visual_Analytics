...
participant1_data_4 <- participant1_data_4 %>%
  mutate (final_meal_status = case_when(
    Minutes %in% supper & (hunger_status == 'Start Meal') & (Sleep_Status != 'Sleeping')  ~ "Supper",
    Minutes %in% breakfast & (hunger_status == 'Start Meal') & (Sleep_Status != 'Sleeping') ~ "Breakfast",
    Minutes %in% lunch & (hunger_status == 'Start Meal') & (Sleep_Status != 'Sleeping') ~ "Lunch",
    Minutes %in% dinner & (hunger_status == 'Start Meal') & (Sleep_Status != 'Sleeping') ~ "Dinner")
  )
